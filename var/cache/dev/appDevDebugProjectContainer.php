...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'access.restriction' => 'getAccess_RestrictionService',
            ...
            'fiscalia.distrito' => 'getFiscalia_DistritoService',
            ...
            'security.firewall.map.context.saml_secured' => 'getSecurity_Firewall_Map_Context_SamlSecuredService',
            'security.logout_url_generator' => 'getSecurity_LogoutUrlGeneratorService',
            'security.password_encoder' => 'getSecurity_PasswordEncoderService',
            'security.rememberme.response_listener' => 'getSecurity_Rememberme_ResponseListenerService',
            'security.role_hierarchy' => 'getSecurity_RoleHierarchyService',
            'security.token_storage' => 'getSecurity_TokenStorageService',
            'security.user_checker.saml_secured' => 'getSecurity_UserChecker_SamlSecuredService',
    ...
    /**
     * Gets the 'access.restriction' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AccessBundle\Controller\RestrictionController A AccessBundle\Controller\RestrictionController instance.
     */
    protected function getAccess_RestrictionService()
    {
        return $this->services['access.restriction'] = new \AccessBundle\Controller\RestrictionController($this->get('doctrine.orm.default_entity_manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Dac\TemplateBundle\Menu\MenuBuilder A Dac\TemplateBundle\Menu\MenuBuilder instance.
     */
    protected function getApp_MenuBuilderService()
    {
        return $this->services['app.menu_builder'] = new \Dac\TemplateBundle\Menu\MenuBuilder($this->get('knp_menu.factory'), $this->get('doctrine.orm.default_entity_manager'), $this->get('security.token_storage'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '192.168.57.76', 'port' => 5432, 'dbname' => 'DEV', 'user' => 'control', 'password' => 'Dac123', 'charset' => 'UTF8', 'driverOptions' => array('search_path' => 'control'), 'driverClass' => 'Dac\\TemplateBundle\\Doctrine\\DBAL\\Driver\\PDOPgSql\\Driver', 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Dac/TemplateBundle/Entity'), 1 => ($this->targetDirs[3].'/src/ClippingBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Dac\\TemplateBundle\\Entity');
        $c->addDriver($b, 'ClippingBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('DacTemplateBundle' => 'Dac\\TemplateBundle\\Entity', 'ClippingBundle' => 'ClippingBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_89a6bfd10b842954a8874a368006e01398312510504d5549a7e27a71318f1687');
    ...
    /**
     * Gets the 'fiscalia.distrito' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dac\TemplateBundle\Controller\DistritoController A Dac\TemplateBundle\Controller\DistritoController instance.
     */
    protected function getFiscalia_DistritoService()
    {
        return $this->services['fiscalia.distrito'] = new \Dac\TemplateBundle\Controller\DistritoController($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.saml_secured' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.saml_secured' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_SamlSecuredService()
    {
        ...
        return $this->services['security.firewall.map.context.saml_secured'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($e, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \AccessBundle\Security\Firewall\SamlListener($b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $e, $c)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), new \Symfony\Component\Security\Http\HttpUtils($d, $d), 'saml_secured', NULL, NULL, NULL, $a, true));
    }
    ...
    /**
     * Gets the 'security.user_checker.saml_secured' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_UserChecker_SamlSecuredService()
    {
        return $this->services['security.user_checker.saml_secured'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('node', 'http://192.168.57.76:3000');
        $instance->addGlobal('gis', 'http://dev-sig.mpf.gov.ar:8080/geoserver/dac/');
        $instance->addGlobal('map_cache', 'http://192.168.2.123:8080/service?');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Dac/TemplateBundle/Resources/views'), 'DacTemplate');
        $instance->addPath(($this->targetDirs[3].'/src/ClippingBundle/Resources/views'), 'Clipping');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('48bf6a6bc518ddbc4bc998e688d3ccf1ee89f9e0');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \AccessBundle\Security\Authentication\Provider\SamlProvider(new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'DacTemplateBundle:User', 'username', NULL), (__DIR__.'/security/nonces'))), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DacTemplateBundle' => 'Dac\\TemplateBundle\\DacTemplateBundle',
                'ClippingBundle' => 'ClippingBundle\\ClippingBundle',
            ...
            'database_host' => '192.168.57.76',
            'database_port' => 5432,
            'database_name' => 'DEV',
            'database_user' => 'control',
            'database_password' => 'Dac123',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '48bf6a6bc518ddbc4bc998e688d3ccf1ee89f9e0',
            'node' => 'http://192.168.57.76:3000',
            'map_cache' => 'http://192.168.2.123:8080/service?',
            'gis' => 'http://dev-sig.mpf.gov.ar:8080/geoserver/dac/',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '48bf6a6bc518ddbc4bc998e688d3ccf1ee89f9e0',
            ...
            'access.retriction.class' => 'AccessBundle\\Controller\\RestrictionController',
            'fiscalia.distrito.class' => 'Dac\\TemplateBundle\\Controller\\DistritoController',
